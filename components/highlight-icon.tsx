/**
 * Iconos pixelados de los destacados del Acerca de, dibujados con `rect`. Port
 * de `HighlightIcon` de `references/templates/home-about/about.jsx`.
 *
 * Usan `currentColor`, así que el neón lo pone el color del destacado padre
 * (`.highlight.magenta`, `.cyan`, `.green`).
 */
