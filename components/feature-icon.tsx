/**
 * Iconos pixelados de las tarjetas de "¿Por qué Arcade Vault?", dibujados con
 * `rect`. Port de `FeatureIcon` de `references/templates/home-about/home.jsx`.
 *
 * Usan `currentColor`, así que el neón lo pone el color de la tarjeta padre
 * (`.feature-card.cyan`, `.yellow`, `.magenta`, `.green`).
 */
