/**
 * Siluetas pixeladas de formas arcade clásicas que flotan detrás del hero.
 * Port de `FloatingSilhouettes` de `references/templates/home-about/home.jsx`.
 * Puramente decorativo: posición, tamaño y animación los pone `.silo` en
 * `app/globals.css`.
 */
